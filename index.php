        ...
        <div class="row">
          <div class="large-6 small-12 columns">
            ...
            <ul id="redes2" class="button-group">
              ...
              <li><a href="https://plus.google.com/+TransportadorasantanaCol" class="step fi-social-google-plus size-social" rel="publisher" target="blank"></a></li>
            </ul>
            <br><br><br><br>
